...
The Membership Evaluation process ("Membership Eval") occurs once per academic year, where Active Members are evaluated.
...
Any Active Member who has completed all the requirements as defined in \ref{Expectations of Active Members} at the beginning of the Membership Eval passes their Membership Evaluation without being voted on.
